...
%>
            <div align="center" id="all">
                ...
                <br>
                <div id="exceptimg">
                    <div id="what">비밀번호 찾기</div></div>
                    <div id="the">
                      
                        <br>
                        <form name="loginForm" action="final-findPwTask.jsp" method="post">
                        <div id="containing">
                            <div id="idpsswd">
                        ...
                        <input type="text" name="rmail" class="txt">
                            ...
                            <div id="register">
                                ...
                                <button type="submit" id="registerButton" class="button">비밀번호 찾기</button>
                            </div>
                        </div>
                        </form>
